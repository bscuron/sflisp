...
System.debug(i.eval('(defun fib (n) (if (<= n 1) n (+ (fib (- n 1)) (fib (- n 2))))) (fib 10)')); // 55

System.debug(i.eval('(let ((x \'(("id0" . (("Id" . "ID 0") ("Name" . "Name 0"))) ("id1" . (("Id" . "ID 1") ("Name" . "Name 1")))))) (cdr (assoc "Name" (cdr (assoc "id1" x)))))')); // Name 1
```